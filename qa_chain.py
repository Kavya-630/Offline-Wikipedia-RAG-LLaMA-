...
# ---------------------------------------------------------------------
LLAMA_PATH = os.getenv("LLAMA_MODEL_PATH", "models/phi-3-mini-4k-instruct.Q4_K_M.gguf")
LLAMA_URL = "https://drive.google.com/uc?export=download&id=14skIKTtf74W8aB95lyLgYR58M8CiQScm"
